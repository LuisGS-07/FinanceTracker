...
{
    public partial class RecibosNonimal : Form
    {
        private string username = "";
        public RecibosNonimal(string user)
        {
            InitializeComponent();
            this.username = user;
        }
        ...
        double CalculoTENominal(double dias)
        {
            ...
            switch (cboCapitalizacion.SelectedIndex)
            {
                case 0:
                    n1 = 1;//diaria
                    break;
            ...
            double n = dias / n1;//esponente de la funcion
            double m = n2 / n1;//es el resultado de dividir el tiempo de la tasa con el perioso de capitalizacion
            double paso1 = (Convert.ToDouble(txtTasa.Text) / 100);
            double paso2 = (1 + (paso1 / m));
            double paso3 = (Math.Pow(paso2, n) - 1) * 100;
        ...
        private void RecibosNonimal_Load(object sender, EventArgs e)
        {
        ...
        private void btnContinuar_Click_1(object sender, EventArgs e)
        {
            ...
            txtNominalOutput.Text = txtNominal.Text;
